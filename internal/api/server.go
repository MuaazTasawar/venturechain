...
// server instance.
func NewServer(chain *blockchain.Blockchain, mp *mempool.Mempool, peers *p2p.PeerList, treasuryAddr string, escrowWallet *wallet.Wallet, internalAPIKey string) *Server {
	return &Server{
		Chain:          chain,
		Mempool:        mp,
		Peers:          peers,
